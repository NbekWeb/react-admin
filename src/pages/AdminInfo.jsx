...
const ProjectContainerBlock = ({ label, placeholder }) => (
...
const UserInfo = () => (
  <div className="project-container-content">
    <ProjectContainerBlock label="Фамилия" placeholder="Фамилия" />
    <ProjectContainerBlock label="Имя" placeholder="Имя" />
    <ProjectContainerBlock label="Отчество" placeholder="Фамилия" />
  </div>
);

const ContactInfo = () => (
  <div className="project-container-content">
    <ProjectContainerBlock label="Телефон" placeholder="9 999 999 99 99" />
    <ProjectContainerBlock label="Организация" placeholder="OOO dve" />
    <ProjectContainerBlock label="E-mail" placeholder="example@yandex.ru" />
  </div>
);
